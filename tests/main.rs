...
fn test_terraform_workflow() {
    ...
    terve(&home_dir)
        ...
        .success()
        .code(0)
        .stdout(contains("1.0.3").and(contains("0.14.11")));
    ...
    terve(&home_dir)
        ...
        .success()
        .code(0)
        .stdout(contains("Installed terraform 1.0.3"));
    ...
    for _ in 1..=2 {
        terve(&home_dir)
            ...
            .success()
            .code(0)
            .stdout(contains("Installed terraform 0.14.11"));
    }
    ...
    for _ in 1..=2 {
        terve(&home_dir)
            ...
            .success()
            .code(0)
            .stdout(contains("Selected terraform 0.14.11"));
    }
    ...
    terve(&home_dir)
        ...
        .success()
        .code(0)
        .stdout(contains("Removed terraform 1.0.3"));
...
fn test_terragrunt_workflow() {
    ...
    terve(&home_dir)
        ...
        .success()
        .code(0)
        .stdout(contains("0.29.2").and(contains("0.18.0")));
    ...
    for _ in 1..=2 {
        terve(&home_dir)
            ...
            .success()
            .code(0)
            .stdout(contains("Installed terragrunt 0.29.2"));
    }
    ...
    for _ in 1..=2 {
        terve(&home_dir)
            ...
            .success()
            .code(0)
            .stdout(contains("Selected terragrunt 0.29.2"));
    }

    // Install another version (for which sha256 checksum is not available)
    terve(&home_dir)
        .arg("i")
        .arg("tg")
        .arg("0.18.0")
    ...
    Command::new(hard_link_path)
        ...
        .success()
        .code(0)
        .stdout(contains("terragrunt version v0.29.2"));
